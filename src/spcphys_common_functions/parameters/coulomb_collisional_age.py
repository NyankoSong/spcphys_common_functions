...
def calc_Ac(v_j: u.Quantity,
    ...
    Te_j = T_to_E(T_j).to(u.eV) if T_j.unit.is_equivalent(u.K) else T_j.to(u.eV) # in eV
    Te_i = T_to_E(T_i).to(u.eV) if T_i.unit.is_equivalent(u.K) else T_i.to(u.eV) # in eV
